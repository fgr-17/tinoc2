...
/** \mainpage CMSIS Cortex-M0
  ...
  Modificaciones CITEDEF 2017:

  	  - Se agregaron los archivos LPC1102_IOCON.c y .h, que contienen las asociaciones de
  	  ...
  	  - También se incluyeron definiciones de mascaras, bits, funciones, etc.
