 ...
 * \file	gpio.c
 *
 * \brief 	GPIO C file for NXP LPC11xx Family Microprocessors
 * \brief 	\n History
 * \brief 	\arg 2009.12.09  ver 1.01    GPIOSetValue() updated
 * \brief 	\arg 2008.07.20  ver 1.00    Preliminary version, first Release
 *
 * \author Copyright(C) 2008, NXP Semiconductor. All rights reserved.
 * \author Roux, Federico G. (froux@citedef.gob.ar). CITEDEF2014
 *
 */
